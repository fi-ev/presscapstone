        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            ...
            <form  wire:submit.prevent="submit" class="space-y-4 col-span-1 md:col-span-2">
                ...
                <div>
                    ...
                    <x-input id="salary_grade" wire:model="salary_grade" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600 placeholder:text-gray-400" placeholder="1" type="number" name="salary_grade" :value="old('salary_grade', $editPosition->salary_grade)" autofocus autocomplete="salary_grade" />
                ...
                <div>
                    ...
                    <x-input id="monthly_salary" wire:model="monthly_salary" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600 placeholder:text-gray-400" placeholder="0.00" type="text" name="monthly_salary" :value="old('monthly_salary', $editPosition->monthly_salary)" autofocus autocomplete="monthly_salary" />
                ...
                <div>
                    ...
                    <x-input id="education" wire:model="education" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600 placeholder:text-gray-400" placeholder="0.00" type="text" name="education" :value="old('education')" autofocus autocomplete="education" />
                ...
                <div>
                    ...
                    <x-input id="work_experience" wire:model="work_experience" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600 placeholder:text-gray-400" placeholder="0.00" type="text" name="work_experience" :value="old('work_experience')" autofocus autocomplete="work_experience" />
