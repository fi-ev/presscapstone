        ...
        <div class="p-4 md:p-5">
            ...
            <form wire:submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    @if($editVacancy && $editVacancy->filepath)
                        <div class="mt-2 text-xs">
                            <strong>Uploaded: </strong>
                            <a href="{{ asset('uploads/' . $editVacancy->filepath) }}" target="_blank" class="text-blue-600 dark:text-blue-300">
                                {{ $editVacancy->filename }}
                            </a>
                        </div>
                    @endif
