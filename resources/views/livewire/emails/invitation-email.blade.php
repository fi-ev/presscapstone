<div>
    <label for="invitation_message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-200">
    ...
    <form wire:submit.prevent="submit">
        <textarea id="invitation_message" rows="16" 
        ...
        wire:model="invitation_message"></textarea>
        <x-button class="mt-4">
            APPLY CHANGES
        </x-button>
