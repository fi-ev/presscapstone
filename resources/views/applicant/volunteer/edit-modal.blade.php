    ...
    <div class="relative bg-white rounded-lg shadow dark:bg-gray-800 max-w-md mx-auto p-4 md:p-5 w-full max-h-screen overflow-y-auto">
        ...
        <div class="flex items-center justify-between dark:border-gray-600">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-200">
                Edit Volunteer Work Experience
            </h3>
            <button
                type="button"
        ...
        <div class="p-4 md:p-5">
            ...
            <form wire:submit.prevent="submit" class="space-y-4">
                <div>
                    <x-label class="text-blue-700 dark:text-blue-300" for="organization_name" value="{{ __('Name of Organization*') }}" />
                    <x-input id="organization_name" wire:model="organization_name" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600" type="text" name="organization_name" autofocus autocomplete="organization_name" required />
                    @error('organization_name') <span class="text-red-600 text-xs font-semibold">{{ $message }}</span> @enderror     
                </div>

                <div>
                    <x-label class="text-blue-700 dark:text-blue-300" for="organization_address" value="{{ __('Address of Organization*') }}" />
                    <x-input id="organization_address" wire:model="organization_address" class="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-800 sm:text-sm sm:leading-6 text-gray-900 border border-gray-300 rounded-lg w-80 bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-300 dark:text-gray-200 dark:focus:bg-gray-700 dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:ring-gray-600" type="text" name="organization_address" autofocus autocomplete="organization_address" required />
                    @error('organization_address') <span class="text-red-600 text-xs font-semibold">{{ $message }}</span> @enderror     
                </div>
                ...
                <div>
                    <x-label class="text-blue-700 dark:text-blue-300" for="position" value="{{ __('Position*') }}" />
